...
public:
	...
	double* x_position3_ptr;
	double* x_position3_unc_ptr;
	double* y_position3_ptr;
	double* y_position3_unc_ptr;
	double* heading3_ptr;
	double* heading3_unc_ptr;
	double* north_angle3_ptr;
	double* north_angle3_unc_ptr;
