...
NB1_To_I7_Serial::NB1_To_I7_Serial(buffer_RW_t buffer_RW)
{
/*
	reader = false;
	read_buffer = 0;
...
void NB1_To_I7_Serial::unpackMsg()
{
    /**
	...
	msg.acc_x_mean 			= pkt.acc_x_mean*0.00025/65536.0;
	msg.acc_y_mean 			= pkt.acc_y_mean*0.00025/65536.0;
	msg.acc_z_mean 			= pkt.acc_z_mean*0.00025/65536.0;
	msg.rate_p_mean        	= pkt.rate_p_mean*0.02/65536.0;
	msg.rate_q_mean        	= pkt.rate_q_mean*0.02/65536.0;
	msg.rate_r_mean        	= pkt.rate_r_mean*0.02/65536.0;
...
void NB1_To_I7_Serial::packMsg(const messages::nb1_to_i7_serial_msg::ConstPtr& msg)
{
    /**
...
void NB1_To_I7_Serial::publishMsg(ros::Publisher* pub_ptr)
{
	pub_ptr->publish(msg);
}


void NB1_To_I7_Serial::subscribeMsg()
{
	sub = nh.subscribe<messages::nb1_to_i7_serial_msg>("comm/nb1out/wrongmsg", 1, &NB1_To_I7_Serial::packMsg, this);
}


void NB1_To_I7_Serial::debug_print_packet_data(int res)
{
